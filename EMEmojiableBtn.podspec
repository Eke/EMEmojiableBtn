...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "EMEmojiableBtn is awsome UIView"
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = <<-DESC
EMEmojiableBtn is awsome UIViewEMEmojiableBtn is awsome UIViewEMEmojiableBtn is awsome UIViewEMEmojiableBtn is awsome UIView
                       DESC
